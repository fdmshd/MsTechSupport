 ...
 */
final class Version20210713043904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, subject VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, file VARCHAR(255) DEFAULT NULL, date DATETIME NOT NULL, INDEX IDX_97A0ADA312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
